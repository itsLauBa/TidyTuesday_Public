...
```{r}
title_text = 'Foundations of \nnews organisations'
subtitle_text = 'with corresponding language'
...
ggplot(data_plot, aes(x = year_founded)) +
  ...
  theme(text = element_text(family = 'ubuntu'),
    panel.background = element_rect(fill='grey25', color='gray81'),
        ...
        plot.title = element_text(color='gray100', size=20, hjust=0.1, vjust = -17, face='bold'),
        plot.subtitle = element_text(color='gray100', hjust=0.1, vjust = -23, size=15, face='italic')
  )
```
